---
title: "HVAC Delta T: Normal Range and What a Bad Reading Means"
meta_title: "What Is Delta T in HVAC? Normal Range & Diagnostics | TradesQuote"
description: "What Delta T is in HVAC — the temperature split for AC and furnaces — the normal ranges, how to measure it, and what high or low readings tell you about a system."
date: 2026-05-20T09:00:00Z
image: /images/posts/hvac-delta-t-hero.webp
categories: ["hvac"]
tags: ["delta t","temperature split","diagnostics","hvac technician"]
draft: false
---

import BlogInfographic from "@/components/blog/BlogInfographic.astro";
import DeltaTConceptDiagram from "@/components/blog/delta-t/DeltaTConceptDiagram.astro";
import DeltaTMeasureStepsDiagram from "@/components/blog/delta-t/DeltaTMeasureStepsDiagram.astro";
import DeltaTDiagnosticFlowDiagram from "@/components/blog/delta-t/DeltaTDiagnosticFlowDiagram.astro";
...
Delta T in HVAC is simply the difference between the air temperature entering the system and the air leaving it.
...
<BlogInfographic
  title="How Delta T works"
  caption="Cooling: return minus supply. Heating: supply minus return."
>
  <DeltaTConceptDiagram />
</BlogInfographic>

## Normal Delta T Ranges

| System | Measurement | Normal Range |
|---|---|---|
| Central AC (split system) | Return temp minus supply temp | 16–22°F |
| Heat pump in cooling | Return temp minus supply temp | 16–22°F |
| Gas furnace | Supply temp minus return temp | 40–70°F |
| Heat pump in heating | Supply temp minus return temp | 25–35°F |
...
<BlogInfographic
  title="How to measure Delta T in the field"
  caption="Use a probe thermometer at the return grille and nearest supply register after 10–15 minutes of continuous run time."
>
  <DeltaTMeasureStepsDiagram />
</BlogInfographic>
...
- Low refrigerant charge reduces the coil's ability to absorb heat — see how to tell an **[overcharged system from an undercharged one](/blog/refrigerant-overcharge-vs-undercharge)** before adjusting anything
...
**Oversized system**
An oversized AC unit short-cycles. It cools the space quickly but never runs long enough to pull humidity or establish a stable temperature split. The measured Delta T will be inconsistent and often low.
...
Every finding from Delta T should lead to a second verification step — a **[static pressure test](/blog/hvac-static-pressure)** to confirm an airflow restriction, **[superheat and subcooling readings](/blog/superheat-vs-subcooling)** to check the refrigerant side, combustion analysis, or visual inspection. A reading inside the normal range does not rule out all problems either; a system can have partially offsetting faults that produce a normal-looking split.

<BlogInfographic
  title="Delta T triage for cooling mode"
  caption="Use split direction to narrow the first checks — always confirm with a second measurement."
>
  <DeltaTDiagnosticFlowDiagram />
</BlogInfographic>

## Use the Free Calculator

> **[Delta T Calculator](/calculators/hvac/hvac-delta-t-calculator)** — get your exact answer in seconds.

For the delta-T equation alongside the rest of the field math, keep the **[HVAC formulas cheat sheet](/blog/hvac-formulas-cheat-sheet)** handy.
...
Delta T in HVAC is the temperature difference between the air entering and leaving a system — return minus supply in cooling, supply minus return in heating. It is the fastest field check for how much heat an AC, heat pump, or furnace is transferring in a single pass, before pulling out gauges or a multimeter.
