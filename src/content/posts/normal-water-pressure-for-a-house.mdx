...
Everything above assumes a municipal main holding a steady pressure. On a well the pressure switch and the tank set it instead, and the two ends of the band — cut-in and cut-out — are what you are actually adjusting when you chase pressure. Raising them has a cost most people are not told about: it *reduces* how much water the tank delivers per pump cycle, because drawdown is a ratio of absolute pressures rather than a difference. That arithmetic, and why an over-charged tank looks exactly like a dead one, is in **[what size well pressure tank you need](/blog/what-size-pressure-tank-do-i-need)**.
