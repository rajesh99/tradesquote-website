...
Wet venting is one arrangement among several, and the names around it cause more confusion than the principles do — particularly the two that are the same words in a different order. **[Stack vent vs vent stack](/blog/stack-vent-vs-vent-stack)** sorts out which pipe is which, and which of them every building has by definition.
