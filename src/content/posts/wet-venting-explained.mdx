...
**Assuming your jurisdiction reads it the same way.** Wet venting provisions have changed across code cycles, and the UPC's approach differs from the IPC's. Roughly fifteen states enforce the UPC or a derivative. This is a rule worth confirming with your AHJ before rough-in rather than after.
