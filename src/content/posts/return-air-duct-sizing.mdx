...
## Calculate Return Air Duct Size

To **calculate return air duct size**, start with total system CFM (about 400 CFM per ton), then size the return duct at a lower velocity than supply — typically one size larger for the same airflow. A **return air duct sizing calculator** does this automatically: enter CFM, friction rate, and duct shape to get round or rectangular dimensions with velocity checked.

**Quick method:** 3-ton system → ~1,200 CFM return → 18-inch round trunk (or equivalent rectangular) at residential friction rates.

## Size Your Returns

> **[Duct Size Calculator](/calculators/hvac/hvac-duct-size-calculator)** — **return air duct sizing calculator**: enter return CFM and get duct size with velocity checked.
