...
**The installed cost**, which is rarely just the appliance. On a like-for-like 50-gallon gas swap the unit is only about **53%** of the invoice; the rest is labour, permit, haul-away and the code upgrades an inspector will want. The **[Water Heater Replacement Cost Calculator](/calculators/plumbing/plumbing-water-heater-replacement-cost-calculator)** breaks it down.
