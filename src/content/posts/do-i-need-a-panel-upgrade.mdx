...
> **[Service Size Calculator](/calculators/electrical/electrical-service-size-calculator)** — accepts either a 220.82 calculated load or a 220.87 measured figure, and tells you whether the existing service covers it.

Run the paper number with the **[Load Calculator](/calculators/electrical/electrical-load-calculator)**, then run the measured number through the **[Service Size Calculator](/calculators/electrical/electrical-service-size-calculator)** — if they disagree, 220.87 is the one worth pursuing. Size the EV circuit with the **[EV Charger Calculator](/calculators/electrical/electrical-ev-charger-calculator)**, and if an upgrade really is warranted, price it with the **[Panel Upgrade Cost Calculator](/calculators/electrical/electrical-panel-upgrade-cost-calculator)**. The method behind the paper number is in **[Residential Load Calculation](/blog/residential-electrical-load-calculation)**.
