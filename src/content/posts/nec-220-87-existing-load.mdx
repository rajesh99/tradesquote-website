...
The two calculated methods disagree with each other by about 21% — that comparison is worked on the same house, method by method, in **[Residential Load Calculation](/blog/residential-electrical-load-calculation)**. But both of them sit roughly twice the measured figure, and that's not an error in either direction.
