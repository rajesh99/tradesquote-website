...
And that's the doorway to power factor generally: once current and voltage are out of phase, volts × amps stops equalling watts. See **[kVA vs kW](/blog/kva-vs-kw)** and **[Three-Phase Power](/blog/three-phase-power-calculation)**.
