...
meta_title: "HVAC Static Pressure: Testing & Diagnostics | TradesQuote"
...
## Calculate Duct Static Pressure

To **calculate duct static pressure** in the field, measure supply static at the plenum (+) and return static at the inlet (−), then add absolute values for TESP. **Calculating static pressure in ductwork** follows the same method whether you use a magnahelic gauge or digital manometer - the key is stable runtime (10+ minutes) and test holes at the correct distances from the air handler.

For design work, friction-rate tables size individual duct runs so the cumulative **calculating static pressure in ductwork** total stays within the blower's rated TESP budget. See **[Calculating Ductwork Size](/blog/calculating-ductwork-size)** for duct friction and velocity rules.

## Use the Free Calculator

> **[Static Pressure Calculator](/calculators/hvac/hvac-static-pressure-calculator)** - **calculate duct static pressure** from supply and return readings.
