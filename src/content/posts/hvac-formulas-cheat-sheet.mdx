...
The 2023 DOE testing change (M1) raised external static pressure during the test, so the newer SEER2 rating runs about 5% below the old SEER number for the same equipment. The exact factor is 0.9524 for split systems. The **[HVAC Formulas reference](/calculators/hvac/formulas)** includes a SEER/SEER2 converter and a savings calculator.
