...
Comparing "cost per unit of fuel" misleads you. A gas furnace wastes some fuel up the flue; a heat pump moves heat rather than generating it. The only fair comparison is cost per 100,000 BTU of heat actually delivered to your living space. This is the same delivered-cost methodology we use to break down **[the cost to run central AC](/blog/cost-to-run-central-ac)** on the cooling side.

**Gas furnace example:** A 96% AFUE furnace at $1.20/therm delivers 96,000 BTU per therm. Cost per 100,000 BTU delivered = ($1.20 / 96,000) x 100,000 = **$1.25**. (Whether that 96% furnace is worth its price premium in the first place is a separate question — we cover it in **[is a 95% AFUE furnace worth it](/blog/95-afue-furnace-worth-it)**.)
...
Cold-climate heat pumps (sometimes called hyper-heat or cold-climate models) maintain a COP around 1.8 even at -13°F, which is their rated minimum operating point. Standard models may lock out or run far less efficiently below 5–10°F. Getting the capacity right is critical in these conditions — see **[what size heat pump you need in cold climates](/blog/heat-pump-sizing-cold-climates)** before specifying equipment.
