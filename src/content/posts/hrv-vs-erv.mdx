...
meta_title: "HRV vs ERV: Differences, Costs & Choice | TradesQuote"
...
**Best fit:** Climate zones 1–3 (hot, humid summers). An ERV reduces the latent load on the air conditioner, lowering runtime and energy use. In very humid regions it pairs well with dedicated moisture control - see **[how to size a dehumidifier](/blog/how-to-size-dehumidifier)** for the spaces an ERV alone cannot keep dry. It is also a strong choice in very tight cold-climate homes where indoor RH drops below 30% in winter and occupants cannot tolerate the dry air even with a humidifier.
...
ASHRAE 62.2 sets the minimum whole-building ventilation rate for residential buildings. For the full breakdown of the standard and how the rate is derived, see the guide to **[ASHRAE 62.2 ventilation requirements](/blog/ashrae-62-ventilation)**:
...
The unit you select must be rated at or above this flow at the external static pressure of your duct system. Most residential HRVs and ERVs are rated between 60 and 200 CFM - if you need a refresher on **[what CFM measures and how airflow is calculated](/blog/what-is-cfm-hvac)**, start there. Manufacturers publish performance curves - verify the CFM at actual system resistance, not just at free air.
