...
Superheat tells you what the refrigerant is doing at the evaporator outlet; subcooling tells you what it is doing at the condenser outlet — and together they are the two most reliable diagnostic numbers you have for refrigerant charge. They are also the measurements behind telling an **[overcharged system from an undercharged one](/blog/refrigerant-overcharge-vs-undercharge)**.
...
Do not add refrigerant before checking airflow. A dirty evaporator coil can produce high superheat readings identical to a 1-lb undercharge — confirm airflow first with a **[static pressure test](/blog/hvac-static-pressure)** and a **[Delta T reading](/blog/hvac-delta-t-explained)** before you touch the charge.
...
A **superheat and subcooling calculator** (also called a **superheat subcooling calculator**, **subcool and superheat calculator**, or **superheat and subcool calculator**) converts gauge pressures and line temperatures into superheat and subcooling values using the refrigerant's PT chart. Enter suction pressure, suction line temp, liquid pressure, and liquid line temp — the calculator handles saturation lookup and subtraction.

Field workflow: stabilize the system under load, record all four readings, then run the **superheat and subcooling calculator** to compare against target ranges before adding or removing refrigerant.

## Use the Free Calculators

> **[Superheat Calculator](/calculators/hvac/hvac-superheat-calculator)** — superheat from suction pressure and line temperature.

> **[Subcooling Calculator](/calculators/hvac/hvac-subcooling-calculator)** — subcooling from liquid pressure and line temperature.
