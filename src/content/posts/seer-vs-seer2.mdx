...
meta_title: "SEER vs SEER2 Comparison Chart & Conversion | TradesQuote"
description: "SEER2 replaced SEER as the federal efficiency standard in 2023. A side-by-side comparison chart of what changed, how to convert between them, and whether the difference matters when buying."
...
Here is every key difference between the two ratings in one place:

| Attribute | SEER (old) | SEER2 (new) |
|---|---|---|
| Test procedure | M1 | M2 |
| External static pressure | 0.1 in.w.c. | 0.5 in.w.c. |
| In effect | Through Dec 31, 2022 | Since Jan 1, 2023 |
| South/Southwest minimum | 14 SEER | 14 SEER2 |
| North minimum | 13 SEER | 13.4 SEER2 |
| Typical equivalent rating | 14.7 | 14.0 |
| Typical equivalent rating | 16.0 | 15.2 |
| Typical equivalent rating | 18.0 | 17.1 |

Same hardware, harder test — every row above traces back to that one change in static pressure.
...
### Is there a SEER vs SEER2 comparison chart?

Yes — see the comparison chart above for test procedure, static pressure, effective dates, and regional minimums side by side, or the conversion table just below it for how any specific SEER rating maps to SEER2.
