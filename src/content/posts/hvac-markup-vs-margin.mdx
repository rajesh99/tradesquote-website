...
import MarkupMarginCompareDiagram from "@/components/blog/markup-margin/MarkupMarginCompareDiagram.astro";
import TrueJobCostDiagram from "@/components/blog/markup-margin/TrueJobCostDiagram.astro";
import PricingFormulaDiagram from "@/components/blog/markup-margin/PricingFormulaDiagram.astro";
...
<BlogInfographic
  title="50% markup is not 50% margin"
  caption="Markup is added to cost. Margin is profit as a share of selling price — they are not interchangeable."
>
  <MarkupMarginCompareDiagram />
</BlogInfographic>
...
<BlogInfographic
  title="The 30% markup vs 30% margin mistake"
  caption="On a $10,000 job, multiplying by 1.30 leaves $896 on the table. Divide by 0.70 to hit true 30% margin."
>
  <PricingFormulaDiagram />
</BlogInfographic>
...
**Direct labor** must be fully burdened. If a tech earns $28/hr, the true cost to the business is closer to $38-42/hr after payroll taxes (7.65% FICA), workers compensation, liability insurance, and benefits. Use your actual burdened rate, not the hourly wage — our guide to setting an **[HVAC labor rate](/blog/hvac-labor-rate)** walks through how to build that number from the ground up.

**Equipment** should be priced at your actual wholesale cost, not MSRP. Factor in any freight or handling charges. If you need a reference point for where finished prices land, our breakdown of **[how much a new HVAC system costs](/blog/hvac-system-cost)** gives real-world ranges to sanity-check your quotes against.
...
<BlogInfographic
  title="What belongs in true job cost"
  caption="Burdened labor, wholesale equipment, all consumables, permits, drive time, and overhead — before any markup or margin."
>
  <TrueJobCostDiagram />
</BlogInfographic>
...
Margin is only one piece of the quote. For the full workflow of assembling a job cost and turning it into a winning price, see **[how to estimate an HVAC job](/blog/how-to-estimate-hvac-jobs)**.
